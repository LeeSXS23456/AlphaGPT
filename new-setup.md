...
_This file is for your first session only. Once setup is complete, use ARCHITECT.md._
...
> _You are the Architect on this project. Read [your project file], then ARCHITECT.md._
